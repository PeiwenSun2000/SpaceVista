...
def find_all_linear_modules(model: "PreTrainedModel", freeze_vision_tower: bool) -> list[str]:
    ...
    forbidden_modules.add("geometry_encoder")
    forbidden_modules.add("feature_fusion")
    forbidden_modules.add("geometry_merger")
    forbidden_modules.add("geometry_merger_vggt")
    forbidden_modules.add("geometry_merger_dinov3")
