...
import torch
from peft import XLoraConfig, LoraConfig, LoraModel, OFTConfig, PeftModel, TaskType, get_peft_model
...
def _setup_lora_tuning(
    ...
    if is_trainable and adapter_to_resume is None:  # create new lora weights while training
        ...
        elif finetuning_args.finetuning_type == "xlora":
            peft_kwargs = {
                "r": finetuning_args.lora_rank,
                "target_modules": target_modules,
                "lora_alpha": finetuning_args.lora_alpha,
        ...
        if model_args.use_unsloth:
            ...
            if finetuning_args.finetuning_type == "lora":
                ...
                peft_config = XLoraConfig(
                    ...
                    adapters={
                        "0": "your_path/saves/qwen2_5_vl-3b/spatial/rational_video_lora_cross_tabletop/checkpoint-20000/",
                        "1": "your_path/saves/qwen2_5_vl-3b/spatial/rational_video_lora_cross_table/checkpoint-20000/",
                        "2": "your_path/saves/qwen2_5_vl-3b/spatial/rational_video_lora_cross_indoor/checkpoint-20000/",
                        "3": "your_path/saves/qwen2_5_vl-3b/spatial/rational_video_lora_cross_outdoor/checkpoint-20000/",
                    },
                    xlora_depth=8,
...
def init_adapter(
    ...
    if is_trainable and getattr(model, "quantization_method", None) is not None:
        if finetuning_args.finetuning_type not in ["lora", "oft", "xlora"]:
    ...
    elif finetuning_args.finetuning_type in ["lora", "oft","xlora"]:
    ...
    # open encoders
    # for name in ["geometry_merger", "geometry_fusion", "geometry_merger_vggt", "geometry_merger_dinov3"]:
    #     module = getattr(model, name, None)
    #     if module is not None and hasattr(module, "parameters"):
    #         for p in module.parameters():
    #             p.requires_grad = True
    #     else:
    #         print(f"Skip: {name} is missing or None")
    return model