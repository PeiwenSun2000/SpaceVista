...
class Qwen2_5_VLProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        geometry_encoder_inputs: Optional[Any] = None,
        **kwargs: Unpack[Qwen2_5_VLProcessorKwargs],
        ...
        if geometry_encoder_inputs:
            geometry_encoder_inputs = {"geometry_encoder_inputs":geometry_encoder_inputs}
            return BatchFeature(data={**text_inputs, **image_inputs, **videos_inputs,**geometry_encoder_inputs})
